...
class Mail:
    ...
    def send_event_ingestion_follow_up(cls, email: str, name: str) -> None:
        ...
        P.S. If you prefer not to receive these emails click %tag_unsubscribe_url%
        """
        ...
        PostHog Team<br/>
        <br/>
        P.S. If you prefer not to receive these emails <a href="%tag_unsubscribe_url%">unsubscribe here</a>.
        """
