...
def report_invoice_payment_succeeded(
    organization_id: Organization, initial: bool, plan_key: str, billing_period_ends: datetime.datetime,
) -> None:

    organization = Organization.objects.get(id=organization_id)
    payload = {"plan_key": plan_key, billing_period_ends: billing_period_ends}
...
@app.task(ignore_result=True, max_retries=3)
def report_card_validated(
    organization_id: Organization, plan_key: str, billing_period_ends: datetime.datetime,
) -> None:
